...
public class testCard {
    ...
    public void testToString() {
        ...
        assertEquals("5Clubs", c1.toString());
        Card c2 = new Card(11, Suit.Hearts);
        assertEquals("11Hearts", c2.toString());
        Card c3 = new Card(12, Suit.Spades);
        assertEquals("12Spades", c3.toString());
        Card c4 = new Card(13, Suit.Diamonds);
        assertEquals("13Diamonds", c4.toString());
        Card c5 = new Card(14, Suit.Diamonds);
        assertEquals("14Diamonds", c5.toString());
    }
}